      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-3 items-center">
          ...
          <form action={deleteBlog.bind(null, blogId, siteId)}>
            <button type="submit" className="bg-red-900 border border-red-700 hover:bg-red-800 text-red-300 px-5 py-2.5 rounded-lg text-base">
              Delete
            </button>
          </form>
        </div>
      ...
      <div className="grid grid-cols-[1fr_320px] gap-6 items-start">
        <div className="flex flex-col gap-5">
          ...
          <div>
            ...
            <TagsInput defaultValue={blog.tags} />
          </div>
          <div>
